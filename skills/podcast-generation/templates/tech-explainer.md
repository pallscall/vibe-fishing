...
python /mnt/skills/public/podcast-generation/scripts/generate.py \
  --script-file /tmp/user-data/workspace/tech-explainer-script.json \
  --output-file /tmp/user-data/outputs/tech-explainer-podcast.mp3 \
  --transcript-file /tmp/user-data/outputs/tech-explainer-transcript.md
```
